    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-[#f49434] text-white px-6 py-2 rounded-xl font-bold hover:bg-[#c35029] transition shadow-lg shadow-blue-100"
        >
      ...
      <form className="space-y-6">
        ...
        <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm space-y-4">
          <div className="flex items-center gap-2 text-[#f49434] font-bold mb-4">
